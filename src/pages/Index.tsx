...
const projects = [
  {
    title: "TRYVIANS",
    description: "Crypto-powered trivia gaming platform where players compete in a metaverse as Trivian characters, earning Trivian Tokens through quiz competitions and a unique Battle Royale mode.",
    image: ProjectImg1,
    href: "https://trivians.io/",
    tags: ["NFT", "Web3", "AngularJS"],
    githubUrl: "https://github.com/smartcoindev389/TrivianToken",
  },
  {
  ...
  {
    title: "Monsters Clan",
    description: "Monsters Clan, a blockchain-based, third-person NFT game where players buy, train, and battle unique monster NFTs to earn rewards in the $MONS token on the Binance Smart Chain.",
    image: ProjectImg3,
    href: "https://www.monstersclan.com/",
    tags: ["NFT", "React", "ThreeJS"],
    githubUrl: "https://github.com/smartcoindev389/Monster.git",
  },
  {
    title: "Revenant",
  ...
  {
    title: "Space M",
    description: "SpaceM, a Web3 hub on the Avalanche blockchain where users can earn $SPCM tokens through passive income from NFT nodes, play-to-earn gaming, tokenized real estate, and social media engagement.",
    image: ProjectImg5,
    href: "https://spacem.world/",
    tags: ["NFT", "Wordpress", "PHP", "MySQL"],
    githubUrl: "https://github.com/smartcoindev389/space_m.git",
  },
  {
